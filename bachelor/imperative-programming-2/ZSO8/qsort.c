...
int lexographic(const void*, const void*);
int number(const void*, const void*);
...
int lexographic(const void* nrx ,const void* nry) {
	int i;
	int answer = 0;

	student* nr1 = (student*)nrx;
	student* nr2 = (student*)nry;
...
int number(const void* nrx, const void* nry) {
	student* nr1 = (student*)nrx;
	student* nr2 = (student*)nry;
