...
static const char qt_meta_stringdata_CG1_DrawTool[] = {
    "CG1_DrawTool\0\0x,y,color\0"
    "PutPixel(int,int,RGB_Color)\0UpdateWindow()\0"
};
...
const QMetaObjectExtraData CG1_DrawTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CG1_DrawTool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CG1_DrawTool,
      qt_meta_data_CG1_DrawTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CG1_DrawTool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CG1_DrawTool))
