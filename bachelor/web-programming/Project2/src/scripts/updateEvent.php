...
function deleteImages($id, $conn) {
	...
	$query = $conn->prepare("DELETE FROM eventImages WHERE eventid = :eventid ;");
	$query->bindValue(':eventid', $id);
	$query->execute();
}
...
function uploadForm() {
	...
	$query = $conn->prepare("UPDATE event SET startdate = :startdate, enddate = :enddate, street = :street, city = :city, postcode = :postcode, description = :description, tags = :tags, name = :name, price = :price, website = :website, subid = :subid, organisator = :organisator, sponsor = :sponsor WHERE eventid = :eventid ;");
